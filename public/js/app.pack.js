...
/***/ function(module, exports, __webpack_require__) {
	...
	Vue.use(__webpack_require__(91));
	...
	Product = Vue.extend({
	  ...
	  ready: function() {
	    ...
	    this.fx = __webpack_require__(102);
	    this.fx.base = 'USD';
...
/***/ function(module, exports, __webpack_require__) {
	...
	_router2['default'].install = function (Vue) {
	  ...
	  __webpack_require__(83)(Vue, _router2['default']);
	  __webpack_require__(84)(Vue, _router2['default']);
	  __webpack_require__(88)(Vue);
	  __webpack_require__(89)(Vue);
	  __webpack_require__(90)(Vue);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routeRecognizer = __webpack_require__(71);
	...
	function resolveAsyncComponent(handler, cb) {
	  if (!resolver) {
	    resolver = {
	      // HACK
	      resolve: __webpack_require__(74).Vue.prototype._resolveComponent,
	      $options: {
	        components: {
	          _: handler.component
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var historyBackends = {
	  abstract: __webpack_require__(76),
	  hash: __webpack_require__(81),
	  html5: __webpack_require__(82)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$defineProperty = __webpack_require__(78)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function install(Vue) {
	    ...
	    var _ = __webpack_require__(92)(Vue);

	    Vue.url = __webpack_require__(93)(_);
	    Vue.http = __webpack_require__(94)(_);
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div>currency: {{ $parent.currency }}</div><div style=\"overflow:auto;\"><img style=\"float:left; margin-right: 10px;\" src=\"{{ item.img }}\"/><h2>{{ item.name }}</h2><div><div>Release date: {{ item.release_date }}</div><div>Url: <a href=\"{{ item.url }}\">{{ item.url }}</a></div></div></div><div id=\"variants\" ng-if=\"item.variants\"><h3>Variants</h3><div v-repeat=\"variant in item.variants\" class=\"variant\"><div>{{ variant.name }}</div><img src=\"{{ variant.img || item.img }}\"/></div></div><div><h3>Prices</h3><table><tr><th colspan=\"2\">Supplier</th><th>Warehouses</th><th>Price</th></tr><tr v-repeat=\"price in item.prices | orderBy 'price_usd'\"><td style=\"width: 100px; text-align: center;\"><img src=\"/app/img/suppliers/{{ price.supplier }}.png\" alt=\"{{ item.suppliers[price.supplier].name }}\" style=\"max-width: 100px; max-height: 30px;\"/></td><td>{{ item.suppliers[price.supplier].name }}</td><td>{{ item.suppliers[price.supplier].warehouses }}</td><td>{{ price | formatPrice currency }}</td></tr></table><div>Last updated: {{ item.prices_updated }}</div></div><a v-link=\"/\" style=\"margin-top: 100px;\">All products</a>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.rethrow = function rethrow(err, filename, lineno, str){
	  ...
	  try {
	    str = str || __webpack_require__(101).readFileSync(filename, 'utf8')
	  } catch (ex) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<table id=\"product-list\"><tr><th></th><th>Name</th><th>Release Date</th><th>Retail Price</th><th>Best Price</th></tr><tr v-repeat=\"items\"><td class=\"img\"><img src=\"{{ img }}\"/></td><td><a v-link=\"/products/{{id}}\">{{ name }}</a><div><span>{{ items[$index] | getVariants }} variants</span></div></td><td>{{ release_date }}</td><td>{{ items[$index] | getPrice }}</td><td>{{ items[$index] | getBestPrice }}</td></tr></table>");;return buf.join("");
	}
